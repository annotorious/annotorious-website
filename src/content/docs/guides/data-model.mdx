...
Here's another example for a polygon annotation, where the `geometry` object contains a 
list of X/Y points.
...
3. __Ease of Use:__ Annotorious aims to be intuitive and easy to use, with a focus on providing
   ...
   Annotorious' restricted use case allows it to make certain assumptions and simplifications.
...
native data model, with the flexibility to conform to the W3C standard when needed.
