...
2. Create an annotator instance on your image. You can pass
...
3. __Optional:__ you can pass [options](/api-reference/annotorious-opts) to customize the annotator.
...
4. Load existing annotations. Read more about the data model [on the next page](/guides/data-model).
