...
Annotorious provides hooks for accessing the `anno` Annotator instance, annotations, and other API features. 
...
<Aside type="caution" title="Tip">
  ...
  context tag. Forgetting the context wrapper is a small but common mistake.
</Aside>
