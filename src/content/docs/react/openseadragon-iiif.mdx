...
3. __Important:__ wrap your application with the `<Annotorious>` root context tag -
   other Annotorious components depend on it. You can use Annotorious-provided hooks 
   anywhere below the context tag.

4. __Important:__ make sure to memo-ize your OpenSeadragon options to prevent unexpected
  re-renders of the OSD viewer component!
